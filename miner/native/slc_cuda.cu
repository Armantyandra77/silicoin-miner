// Silicoin/SLC CUDA Keccak-256 nonce searcher.
// Standalone native binary — does not know private keys, never sends TXs.
//
// One-shot: ./bin/slc-cuda <challenge32_hex> <miner20_hex> <target32_hex> <startNonceU64> <batchSizeU64>
// Persistent: ./bin/slc-cuda --server  (then stdin: challenge miner target start batch)
